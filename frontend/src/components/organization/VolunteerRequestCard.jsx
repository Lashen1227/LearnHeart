...
const VolunteerRequestCard = ({ request, refreshRequests }) => {
  ...
  const handleAccept = async () => {
    try {
      const response = await fetch("https://learnheart-server.onrender.com/api/volunteers/accept", {
        method: "POST",
        headers: {
  ...
  const handleReject = async () => {
    try {
      const response = await fetch("https://learnheart-server.onrender.com/api/volunteers/reject", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
