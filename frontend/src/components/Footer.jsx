        ...
        <div className="py-10 mx-1 text-center md:text-left">
          <div className="grid gap-8 grid-1 md:grid-cols-2 lg:grid-cols-5">
            ...
            <div className="">
              ...
              <p>
                <a className="text-white hover:text-gray-300"><Link to={'/Login'}>Log in</Link></a>
              </p>
            </div>
            {/* <!-- Contact section --> */}
            <div>
            ...
            <div className=''>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <Link to='/login'>
                    <button className="w-full px-4 py-1 font-bold text-white duration-300 bg-transparent border border-white rounded-2xl hover:scale-110">Log in</button>
                  </Link>
                </div>
            </div>
          </div>
