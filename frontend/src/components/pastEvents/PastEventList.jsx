...
const PastEventList = ({ organizationId, onClose }) => {
    ...
    const fetchEvents = async () => {
        try {
            const response = await axios.get(`https://learnheart-server.onrender.com/api/past-events/organization/${organizationId}`);
    ...
    const handleDeleteConfirm = async () => {
        try {
            await axios.delete(`https://learnheart-server.onrender.com/api/past-events/${selectedEvent._id}`);
            fetchEvents();
    ...
    const handleReviewSubmit = async () => {
        try {
            await axios.post(`https://learnheart-server.onrender.com/api/past-events/${selectedEvent._id}/reviews`, newReview);
            fetchEvents();
